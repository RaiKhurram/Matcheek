...
class VerifyNumNewThreePage extends StatefulWidget {
  bool next;
  VerifyNumNewThreePage({this.next = false});
  @override
  _VerifyNumNewThreePageState createState() {
    return _VerifyNumNewThreePageState();
  }
}

class _VerifyNumNewThreePageState extends State<VerifyNumNewThreePage> {
  int next = 0;
          ...
          children: <Widget>[
            ...
            RichText(
              text: TextSpan(
                  ...
                  style: TextStyle(
                      fontSize: 12, color: Color.fromRGBO(167, 159, 159, 1)),
                  children: <TextSpan>[
                    TextSpan(
