...
class PowerOfPingPage extends StatefulWidget {
  @override
  _PowerOfPingPageState createState() {
    return _PowerOfPingPageState();
  }
}

class _PowerOfPingPageState extends State<PowerOfPingPage> {
  void initState() {
    super.initState();
  }
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text(
                      "Basic",
                      style: TextStyle(
                          fontSize: 25, color: Color.fromRGBO(116, 40, 111, 1)),
                    )
                  ],
                ),
                SizedBox(
                ...
                Row(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(
                          fontSize: 16, color: Color.fromRGBO(116, 40, 111, 1)),
                    )
                  ],
                ),
                SizedBox(
