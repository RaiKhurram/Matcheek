...
class VerifyNumNewTwoPage extends StatefulWidget {
  @override
  _VerifyNumNewTwoPageState createState() {
    return _VerifyNumNewTwoPageState();
  }
}

class _VerifyNumNewTwoPageState extends State<VerifyNumNewTwoPage> {
          ...
          children: <Widget>[
            ...
            RichText(
              text: TextSpan(
                  ...
                  style: TextStyle(fontSize: 14, color:  Color.fromRGBO(167,159,159, 1)),
                  children: <TextSpan>[
                    TextSpan(
...
//                        border: OutlineInputBorder()
            ...
            next ==0 ?Text(
              "Sometimes it may take a couple of minutes for the SMS to arrive. If you had to wait for longer than 5 minutes, please click Resend Code."  ,textAlign: TextAlign.center,
            ):
            RichText(
              text: TextSpan(
