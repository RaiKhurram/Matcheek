...
class NotificationInMobilePage extends StatefulWidget {
  @override
  _NotificationInMobilePageState createState() {
    return _NotificationInMobilePageState();
  }
}

class _NotificationInMobilePageState extends State<NotificationInMobilePage> {
  bool Sound_Notif = true,
      Sound_Msg = true,
      likes = true,
      matches = true,
      message = true,
